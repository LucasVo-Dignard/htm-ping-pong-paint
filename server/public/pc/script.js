...
wallGradient.addColorStop(0.45, '#fffbed');
wallGradient.addColorStop(1, '#fff6d8');
...
boardTextureCanvas.width = 1600;
boardTextureCanvas.height = 1000;
...
const CAMERA_Z = 3;
const NEAR_WALL_MAX = CAMERA_Z - 0.5;
