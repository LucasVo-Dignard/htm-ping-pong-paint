const metalAudioCtx = window.audioCtx || new (window.AudioContext || window.webkitAudioContext)();
 ...
 */
function playMetalSound(baseFreq = 500) {
...
window.playMetalSound = playMetalSound;
